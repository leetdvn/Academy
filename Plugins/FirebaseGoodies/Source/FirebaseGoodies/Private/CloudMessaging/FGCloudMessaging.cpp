...
#if PLATFORM_ANDROID
	FGMethodCallUtils::CallStaticVoidMethod(FGCloudMessagingClassName, "subscribeToTopic", "(Ljava/lang/String;)V", FGJavaConvertor::GetJavaString(Topic));
#elif PLATFORM_IOS
...
#if PLATFORM_ANDROID
	FGMethodCallUtils::CallStaticVoidMethod(FGCloudMessagingClassName, "unsubscribeFromTopic", "(Ljava/lang/String;)V", FGJavaConvertor::GetJavaString(Topic));
#elif PLATFORM_IOS
...
{
	FString Token = FGJavaConvertor::FromJavaString(instanceToken);
	FString Id = FGJavaConvertor::FromJavaString(instanceId);
...
{
	FString MessageId = FGJavaConvertor::FromJavaString(msgId);
...
{
	FString Token = FGJavaConvertor::FromJavaString(token);
