...
#if PLATFORM_ANDROID
	FGMethodCallUtils::CallStaticVoidMethod(FGCrashlyticsClassName, "recordException", "(Ljava/lang/String;)V", FGJavaConvertor::GetJavaString(Message));
#elif PLATFORM_IOS
...
#if PLATFORM_ANDROID
	FGMethodCallUtils::CallStaticVoidMethod(FGCrashlyticsClassName, "log", "(Ljava/lang/String;)V", FGJavaConvertor::GetJavaString(Message));
#elif PLATFORM_IOS
...
#if PLATFORM_ANDROID
	FGMethodCallUtils::CallStaticVoidMethod(FGCrashlyticsClassName, "setUserId", "(Ljava/lang/String;)V", FGJavaConvertor::GetJavaString(Identifier));
#elif PLATFORM_IOS
...
#if PLATFORM_ANDROID
	FGMethodCallUtils::CallStaticVoidMethod(FGCrashlyticsClassName, "setCustomKey", "(Ljava/lang/String;Z)V", FGJavaConvertor::GetJavaString(Key), Value);
#elif PLATFORM_IOS
...
#if PLATFORM_ANDROID
	FGMethodCallUtils::CallStaticVoidMethod(FGCrashlyticsClassName, "setCustomKey", "(Ljava/lang/String;F)V", FGJavaConvertor::GetJavaString(Key), Value);
#elif PLATFORM_IOS
	[[FIRCrashlytics crashlytics] setCustomValue:@(Value) forKey:Key.GetNSString()];
#endif
}
...
#if PLATFORM_ANDROID
	FGMethodCallUtils::CallStaticVoidMethod(FGCrashlyticsClassName, "setCustomKey", "(Ljava/lang/String;I)V", FGJavaConvertor::GetJavaString(Key), Value);
#elif PLATFORM_IOS
	[[FIRCrashlytics crashlytics] setCustomValue:@(Value) forKey:Key.GetNSString()];
#endif
}
...
#if PLATFORM_ANDROID
	FGMethodCallUtils::CallStaticVoidMethod(FGCrashlyticsClassName, "setCustomKey", "(Ljava/lang/String;J)V", FGJavaConvertor::GetJavaString(Key), Value);
#elif PLATFORM_IOS
	[[FIRCrashlytics crashlytics] setCustomValue:@(Value) forKey:Key.GetNSString()];
#endif
}
...
#if PLATFORM_ANDROID
	FGMethodCallUtils::CallStaticVoidMethod(FGCrashlyticsClassName, "setCustomKey", "(Ljava/lang/String;Ljava/lang/String;)V", FGJavaConvertor::GetJavaString(Key), FGJavaConvertor::GetJavaString(Value));
#elif PLATFORM_IOS
