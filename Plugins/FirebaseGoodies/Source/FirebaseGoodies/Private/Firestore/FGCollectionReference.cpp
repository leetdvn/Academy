...
#elif PLATFORM_IOS
	(FIRCollectionReference*)CFBridgingRelease(CollectionReferenceObject);
...
#if PLATFORM_ANDROID
	Result->Init(FGMethodCallUtils::CallObjectMethod(JavaCollectionReferenceObject, "document", "(Ljava/lang/String;)Lcom/google/firebase/firestore/DocumentReference;", FGJavaConvertor::GetJavaString(Path)));
#elif PLATFORM_IOS
...
{
	CollectionReferenceObject = (FIRCollectionReference*)CFBridgingRetain(iosCollectionReference);
