...
#elif PLATFORM_IOS
	(FIRDocumentSnapshot*)CFBridgingRelease(DocumentSnapshotObject);
...
#if PLATFORM_ANDROID
	Result = FGMethodCallUtils::CallBoolMethod(JavaDocumentSnapshotObject, "contains", "(Ljava/lang/String;)Z", FGJavaConvertor::GetJavaString(FieldName));
#elif PLATFORM_IOS
...
#if PLATFORM_ANDROID
	jobject javaField = FGMethodCallUtils::CallObjectMethod(JavaDocumentSnapshotObject, "get", "(Ljava/lang/String;)Ljava/lang/Object;", FGJavaConvertor::GetJavaString(FieldName));
...
UFGDocumentReference* UFGDocumentSnapshot::GetDocumentReference(const FString& Path)
{
	...
	if (!Path.IsEmpty()) {
		javaDocument = FGMethodCallUtils::CallObjectMethod(JavaDocumentSnapshotObject, "getDocumentReference", "(Ljava/lang/String;)Lcom/google/firebase/firestore/DocumentReference;",
			FGJavaConvertor::GetJavaString(Path));
	}
	else {
...
{
	DocumentSnapshotObject = (FIRDocumentSnapshot*)CFBridgingRetain(iosDocumentSnapshot);
}
#endif
